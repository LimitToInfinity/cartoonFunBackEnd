...
class CartoonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cartoon" do
    assert_difference('Cartoon.count') do
      post cartoons_url, params: { cartoon: { image: @cartoon.image, name: @cartoon.name, rating: @cartoon.rating } }, as: :json
    end
  ...
  test "should update cartoon" do
    patch cartoon_url(@cartoon), params: { cartoon: { image: @cartoon.image, name: @cartoon.name, rating: @cartoon.rating } }, as: :json
    assert_response 200
  end
